...
</file><file name="_layout.tsx">import { DarkTheme, DefaultTheme, ThemeProvider } from '@react-navigation/native';
...
</file><file name="TabBarBackground.tsx">// This is a shim for web and Android where the tab bar is generally opaque.
export default undefined;

export function useBottomTabOverflow() {
  return 0;
}
</file><file name="IconSymbol.ios.tsx">import { SymbolView, SymbolViewProps, SymbolWeight } from 'expo-symbols';
...
</file><file name="TabBarBackground.ios.tsx">import { useBottomTabBarHeight } from '@react-navigation/bottom-tabs';
...
</file><file name="IconSymbol.tsx">// This file is a fallback for using MaterialIcons on Android and web.
...
</file><file name="ExternalLink.tsx">import { Link } from 'expo-router';
...
</file><file name="HelloWave.tsx">import { useEffect } from 'react';
import { StyleSheet } from 'react-native';
import Animated, {
  useSharedValue,
  useAnimatedStyle,
...
</file><file name="ThemedText-test.tsx">import * as React from 'react';
...
</file><file name="ThemedText-test.tsx.snap">// Jest Snapshot v1, https://goo.gl/fbAQLP
...
\`;
</file><file name="ParallaxScrollView.tsx">import type { PropsWithChildren, ReactElement } from 'react';
import { StyleSheet } from 'react-native';
import Animated, {
  interpolate,
  useAnimatedRef,
...
</file><file name="HapticTab.tsx">import { BottomTabBarButtonProps } from '@react-navigation/bottom-tabs';
...
</file><file name="useColorScheme.web.ts">import { useEffect, useState } from 'react';
...
</file><file name="useThemeColor.ts">/**
...
</file><file name="useColorScheme.ts">export { useColorScheme } from 'react-native';
...
export const systemPrompt = (projectType: "NEXTJS" | "REACT_NATIVE") => `
${PREFACE}
...
${projectType === "NEXTJS" ? NEXT_JS_ARTIFACT_INFO : REACT_NATIVE_ARTIFACT_INFO}
`;
